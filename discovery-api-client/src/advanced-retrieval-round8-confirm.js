/**
 * BACKEND-1602 QA — ROUND 8 CONFIRM (read-only, PRODUCTION).
 ...
 * New file — modifies nothing. Native fetch. access-token from .env. Usage: node src/advanced-retrieval-round8-confirm.js
 */
